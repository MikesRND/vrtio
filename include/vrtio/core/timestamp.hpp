...
//   - TimeStamp<TsiType::gps, TsfType::real_time> for GPS timestamps
//   - TimeStamp<TsiType::other, TsfType::real_time> for TAI timestamps
//   - TimeStamp<TsiType::none, TsfType::sample_count> for sample-count timestamps
//
